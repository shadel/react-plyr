...
var Plyr = function (_Component) {
  ...
  function Plyr() {
    ...
    _this.setCurrentTime = function (time) {
      return _this.player.currentTime = time;
    };
  ...
  Plyr.prototype.componentDidMount = function componentDidMount() {
    ...
    if (this.player) {
      ...
      this.player.on('loadedmetadata', function () {
        ...
        _this2.props.onLoadedmetadata && (_props = _this2.props).onLoadedmetadata.apply(_props, arguments);
      });
  ...
  Plyr.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (this.props.currentTime && this.props.currentTime !== this.player.currentTime) {
